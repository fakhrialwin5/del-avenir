...
export default function GenerationHighlightsSection() {
  return (
    <section id="highlights" className="py-20 md:py-32 bg-white swiss-grid">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <motion.div
            ...
            variants={fadeInUp}
            className="md:col-span-7 p-8 md:p-10 rounded-3xl bg-black text-white overflow-hidden relative group card-premium overlap-card overlap-negative md:overlap-negative"
          >
            <LiquidGlass variant="dark" intensity={1.2} duration={10}>
              <div className="relative z-10">
                <Award className="w-8 h-8 text-white/40 mb-6" strokeWidth={1.5} />
                <div className="flex items-baseline gap-1.5 mb-3">
                  <span className="font-display text-6xl md:text-7xl text-white">
                    <CountUp target={100} />
                  </span>
